const ELEMENTS = 
{
	...
	elements : {
		...
		N :[7, 2, 57, 1.40, 0.75, 5, 2, 4, 3, 4, 14.007, 2, -3, [-3,-2,-1,0,1,2,3,4,5], 3.04,[0.3, 0.3, 1.0]],
		O :[8, 2, 65, 1.35, 0.73, 6, 1, 3, 2, 2, 16.000, 2, -2, [-2,-1,0,1,2], 3.44,[0.9, 0.3, 0.3]],
		...
		B :[5, 2, 10, 1.55, 0.82, 3, 3, 4, 3, 4, 10.810, 2, 3, [0,1,2,3], 2.04],
...
{		
	...
	aaDescription :{A:"Alanine (Hydrophobic)",
					C:"Cystein (Polar)",
					D:"Aspartate (Acidic)",
					E:"Glutamate (Acidic)",
					F:"PhenylAlanine (Hydrophobic)",
					G:"Glycine (Special Case)",
					H:"Histidine (Basic)",
...
/**
 * Goal: Assign functional groups to atoms
 * @param atom
 */
const FunctionalGroupFinder = 
{
	Carboxylate:"COOH"
};
